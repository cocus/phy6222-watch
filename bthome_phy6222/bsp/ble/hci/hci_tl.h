...
#include <types.h>
    ...
    //
    extern uint8_t hciTestTaskID;
    // HCI OSAL GAP Task ID
    extern uint8_t hciGapTaskID;
    // HCI OSAL l2cap Task ID
    extern uint8_t hciL2capTaskID;
    // HCI OSAL SMP Task ID
    extern uint8_t hciSmpTaskID;
...
#define HCI_EXT_NUM_COMPLETED_PKTS_LIMIT_EVENT 0x041F
    ...
    */
    ...
    /*******************************************************************************
        ...
        @return      None.
    */
    extern void HCI_Init(uint8_t taskID);
    ...
    */
    extern uint16_t HCI_ProcessEvent(uint8_t task_id,
                                     uint16_t events);
